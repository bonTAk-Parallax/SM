...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ['id', 'username', 'profile_pic', 'comment_content', 'comment_like_method', 'commented_date']
...
class ReplySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Reply
        fields = ['id', 'username', 'profile_pic', 'comment', 'reply_content', 'reply_like_method', 'replied_date']
